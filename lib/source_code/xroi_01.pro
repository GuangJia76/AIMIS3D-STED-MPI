  ;
; $Id: //depot/Release/ENVI51_IDL83/idl/idldir/lib/utilities/xroi.pro#1 $
;
...
pro xroi_01, $
    ...
    if N_ELEMENTS(tools) eq 0 then begin
        _tools = STRUPCASE(['Freehand Draw', 'Rectangle', 'Ellipse', $
            'Polygon Draw', 'Selection', 'Translate-Scale'])
    endif else begin
